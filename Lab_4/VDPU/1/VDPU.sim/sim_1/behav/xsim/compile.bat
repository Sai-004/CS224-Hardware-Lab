...
REM
REM Generated by Vivado on Tue Mar 28 16:46:52 +0530 2023
...
echo "xvlog --incr --relax -prj TB_VDPU_vlog.prj"
call xvlog  --incr --relax -prj TB_VDPU_vlog.prj -log xvlog.log
