...
HD_PWD='D:/HardwareLab/FullAdder_4-bit/FullAdder_4-bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder_4bit.tcl
