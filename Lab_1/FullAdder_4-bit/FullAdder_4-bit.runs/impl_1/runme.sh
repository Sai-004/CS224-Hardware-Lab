...
HD_PWD='D:/HardwareLab/FullAdder_4-bit/FullAdder_4-bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fulladder_4bit.tcl -notrace
