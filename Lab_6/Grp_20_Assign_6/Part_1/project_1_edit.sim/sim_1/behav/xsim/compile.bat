...
REM
REM Generated by Vivado on Tue May 02 16:54:00 +0530 2023
...
echo "xvlog --incr --relax -prj dramtb_vlog.prj"
call xvlog  --incr --relax -prj dramtb_vlog.prj -log xvlog.log
