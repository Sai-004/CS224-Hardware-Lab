...
REM
REM Generated by Vivado on Thu Apr 13 20:36:36 +0530 2023
...
echo "xvlog --incr --relax -prj cachetb_vlog.prj"
call xvlog  --incr --relax -prj cachetb_vlog.prj -log xvlog.log
